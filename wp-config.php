...
define( 'WPCACHEHOME', '/home/y/yush25um/pro-living.ru/public_html/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
define('DB_NAME', 'cr95418_rfigra');

/** MySQL database username */
define('DB_USER', 'cr95418_rfigra');

/** MySQL database password */
define('DB_PASSWORD', 'fdgdf354rg');
