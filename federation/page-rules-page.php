	...
	<section class="rules-items">
		<div class="container">
			<article class="clearfix">
				<div class="wow bounceInRight text-box side_right" data-wow-duration="1.5s">
...
Один из участников перемешивает колоду и раздает по 6 карт каждому игроку. Оставшиеся карты – это общая колода, которая далее будет использована в игре.</p>
				...
				<figure class="wow bounceInLeft side_left" data-wow-duration="1.5s"><img src="<?php bloginfo('template_url'); ?>/pics/fed_rules-img-8.jpg" alt="ПОДГОТОВКА К ИГРЕ"></figure>
			</article>
			<article class="clearfix">
				<div class="wow bounceInLeft text-box side_left" data-wow-duration="1.5s">
					<h5>СУПЕРЛИНИИ</h5>
...
Непрерывный ряд из шести фишек одного цвета называется суперлинией. Суперлиния может быть построена по вертикали, горизонтали или диагонали. Как только фишки сформировали суперлинию, они переворачиваются флагом вверх и уже не могут быть смещены со своей позиции. Суперлинии одного цвета могут пересекаться. В этом случае фишка, расположенная на пересечении суперлиний, принадлежит одновременно каждой из них.</p>
				...
				<figure class="wow bounceInRight side_right" data-wow-duration="1.5s"><img src="<?php bloginfo('template_url'); ?>/pics/fed_rules-img-7.jpg" alt="СУПЕРЛИНИИ"></figure>
			</article>
			<article class="clearfix">
				<div class="wow bounceInRight text-box side_right" data-wow-duration="1.5s">
					<h5>ЦЕЛЬ ИГРЫ</h5>
				...
				<figure class="wow bounceInLeft side_left" data-wow-duration="1.5s"><img src="<?php bloginfo('template_url'); ?>/pics/fed_rules-img-6.jpg" alt="ЦЕЛЬ ИГРЫ"></figure>
			</article>
			<article class="clearfix">
				<div class="wow bounceInLeft text-box side_left" data-wow-duration="1.5s">
					<h5>ПРИНЦИП ИГРЫ</h5>
...
Возможна ситуация, при которой в общей колоде не останется ни одной карты. В этом случае игра продолжается с теми картами, которые остаются на руках.</p>
				...
				<figure class="wow bounceInRight side_right" data-wow-duration="1.5s"><img src="<?php bloginfo('template_url'); ?>/pics/fed_rules-img-5.jpg" alt=""></figure>
			</article>
			<article class="clearfix">
				<div class="wow bounceInRight text-box side_right" data-wow-duration="1.5s">
...
– Три карты со звездой, указывающие на города федерального значения — Москву, Санкт-Петербург и Севастополь (-1/+1). Такая карта позволяет заменить любую фишку противника своей (фишка противника при этом не должна являться частью уже построенной суперлинии).</p>
				...
				<figure class="wow bounceInLeft side_left" data-wow-duration="1.5s"><img src="<?php bloginfo('template_url'); ?>/pics/fed_rules-img-4.jpg" alt="СПЕЦИАЛЬНЫЕ КАРТЫ"></figure>
			</article>
			<article class="clearfix">
				<div class="wow bounceInLeft text-box side_left" data-wow-duration="1.5s">
				...
				<figure class="wow bounceInRight side_right" data-wow-duration="1.5s"><img src="<?php bloginfo('template_url'); ?>/pics/fed_rules-img-3.jpg" alt="УГЛОВЫЕ КЛЕТКИ"></figure>
			</article>
			<article class="clearfix">
				<div class="wow bounceInRight text-box side_right" data-wow-duration="1.5s">
					<h5>ПУСТАЯ КАРТА</h5>
				...
				<figure class="wow bounceInLeft side_left" data-wow-duration="1.5s"><img src="<?php bloginfo('template_url'); ?>/pics/fed_rules-img-2.jpg" alt="ПУСТАЯ КАРТА"></figure>
			</article>
			<article class="clearfix">
				<div class="wow bounceInLeft text-box side_left" data-wow-duration="1.5s">
...
Игроки одной команды не имеют права переговариваться или подавать друг другу знаки с целью повлиять на ход игры. В случае нарушения этого правила все представители провинившейся команды должны выложить по одной карте (по своему выбору) и заканчивать игру с меньшим количеством карт на руках. Освободившиеся таким образом карты смешиваются с общей колодой. </p>
				...
				<figure class="wow bounceInRight side_right" data-wow-duration="1.5s"><img src="<?php bloginfo('template_url'); ?>/pics/fed_rules-img-1.jpg" alt="ШТРАФНЫЕ САНКЦИИ "></figure>
			</article>
		...
		<div class="container">
			<div class="row clearfix">
				<div class="cols col-6 col-6-md wrap-box">
					...
					<div class="wow bounceInLeft box-form">
